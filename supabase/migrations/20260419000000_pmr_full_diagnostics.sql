-- ============================================================
-- PMR Full Diagnostics - Todas as perguntas extraidas
...
VALUES ('owner', 'Diagnóstico - Dono/Sócio', 'dono', '[
...
INSERT INTO public.consulting_pmr_form_templates (form_key, title, target_role, fields)
VALUES ('manager', 'Diagnóstico - Gerente', 'gerente', '[
...
INSERT INTO public.consulting_pmr_form_templates (form_key, title, target_role, fields)
VALUES ('seller', 'Diagnóstico - Vendedor', 'vendedor', '[
...
INSERT INTO public.consulting_pmr_form_templates (form_key, title, target_role, fields)
VALUES ('process', 'Diagnóstico - Processos', 'processo', '[
