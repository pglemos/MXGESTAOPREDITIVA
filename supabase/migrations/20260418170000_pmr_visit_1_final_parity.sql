-- ============================================================
-- PMR Visita 1 - Templates Finais e Exaustivos (YOLO Mode)
-- ============================================================
...
VALUES ('vendedor', 'Diagnóstico Comercial – Vendedores', 'vendedor', '[
  ...
  {"key": "routine_discipline", "label": "Disciplina com a Rotina Diária (1-5)", "type": "scale", "required": true},
...
VALUES ('gerente', 'PMR - Diagnóstico Gerencial', 'gerente', '[
  ...
  {"key": "strategic_communication", "label": "Comunicação Estratégica (1-5)", "type": "scale", "required": true},
  {"key": "operational_focus_bottleneck", "label": "Gargalo: Excesso de Foco Operacional (1-5)", "type": "scale", "required": true},
  {"key": "resumo_entrevista", "label": "Resumo da Entrevista (Observações do Consultor)", "type": "textarea"}
]'::jsonb)
ON CONFLICT (form_key) DO UPDATE SET
  title = EXCLUDED.title,
...
VALUES ('dono', 'Diagnóstico Estratégico – Dono da Loja', 'proprietario', '[
  ...
  {"key": "owner_operational_load", "label": "Nível de Carga Operacional do Dono (1-5)", "type": "scale", "required": true},
  {"key": "resumo_entrevista", "label": "Resumo da Entrevista (Observações do Consultor)", "type": "textarea"}
]'::jsonb)
ON CONFLICT (form_key) DO UPDATE SET
  title = EXCLUDED.title,
...
VALUES ('processo', 'Diagnóstico de Processos Críticos', 'processo', '[
  ...
  {"key": "governance_conflicts", "label": "Conflitos Estruturais e Governança (1-5)", "type": "scale", "required": true},
