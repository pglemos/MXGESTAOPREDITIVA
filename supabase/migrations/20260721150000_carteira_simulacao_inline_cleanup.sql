...
BEGIN
  ...
  IF v_is_simulation THEN
    -- auth.uid() deriva de request.jwt.claim.sub. A alteração é LOCAL à
    -- transação, acontece somente após autorização e é restaurada em sucesso
    -- e erro. A RPC base preserva seus locks, validações e escrita atômica.
...
-- DOWN: use supabase/rollbacks/20260721150000_carteira_simulacao_inline_cleanup.sql.
