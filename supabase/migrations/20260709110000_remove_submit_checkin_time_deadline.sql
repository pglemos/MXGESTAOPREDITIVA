-- MX: bloqueio de horário desativado — vendedor pode enviar/editar o
-- fechamento diário a qualquer horário, em qualquer dia, em tempo real.
-- Remove apenas o hard-stop de 09:45 dentro de submit_checkin; mantém
-- inalterada a regra de que o escopo "daily" usa sempre a referência
-- oficial (dia anterior) e as demais validações de payload/permissão.
