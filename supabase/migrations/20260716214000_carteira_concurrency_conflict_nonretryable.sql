-- Carteira Base44: retorna conflitos otimistas como HTTP 409 não retentável.
-- A migration 21:30 usava SQLSTATE 40001, reservado a serialization_failure,
-- embora a revisão obsoleta seja um conflito de domínio já determinado.
...
-- DOWN: use supabase/rollbacks/20260716214000_carteira_concurrency_conflict_nonretryable.sql.
