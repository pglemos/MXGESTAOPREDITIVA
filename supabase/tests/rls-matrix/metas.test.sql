...
SELECT is(rls_matrix.dml_count($$DELETE FROM public.metas WHERE id='eeeeeeee-0000-0000-0000-000000000001'$$), 0::bigint, 'admin: DELETE bloqueado sem policy');
...
SELECT is(rls_matrix.dml_count($$INSERT INTO public.metas (id,store_id,user_id,month,year,target) VALUES (gen_random_uuid(),'11111111-1111-1111-1111-111111111111','aaaaaaaa-0000-0000-0000-000000000004',2,2099,200)$$), 0::bigint, 'dono: INSERT bloqueado');
SELECT is(rls_matrix.dml_count($$UPDATE public.metas SET target=target WHERE store_id='11111111-1111-1111-1111-111111111111'$$), 0::bigint, 'dono: UPDATE bloqueado');
SELECT is(rls_matrix.dml_count($$DELETE FROM public.metas$$), 0::bigint, 'dono: DELETE bloqueado');
...
SELECT is(rls_matrix.dml_count($$UPDATE public.metas SET target=0 WHERE store_id='22222222-2222-2222-2222-222222222222'$$), 0::bigint, 'gerente: UPDATE loja alheia bloqueado');
...
SELECT is(rls_matrix.dml_count($$INSERT INTO public.metas (id,store_id,user_id,month,year,target) VALUES (gen_random_uuid(),'11111111-1111-1111-1111-111111111111','aaaaaaaa-0000-0000-0000-000000000004',4,2099,1)$$), 0::bigint, 'vendedor: INSERT bloqueado');
SELECT is(rls_matrix.dml_count($$UPDATE public.metas SET target=0$$), 0::bigint, 'vendedor: UPDATE bloqueado');
SELECT is(rls_matrix.dml_count($$DELETE FROM public.metas$$), 0::bigint, 'vendedor: DELETE bloqueado');
...
SELECT is(rls_matrix.dml_count($$UPDATE public.metas SET target=0$$), 0::bigint, 'anon: UPDATE bloqueado');
SELECT is(rls_matrix.dml_count($$DELETE FROM public.metas$$), 0::bigint, 'anon: DELETE bloqueado');
