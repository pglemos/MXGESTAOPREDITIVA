...
SELECT is(rls_matrix.dml_count($$UPDATE public.logs_auditoria SET action='changed'$$), 0::bigint, 'admin: UPDATE bloqueado append-only');
SELECT is(rls_matrix.dml_count($$DELETE FROM public.logs_auditoria$$), 0::bigint, 'admin: DELETE bloqueado append-only');
...
SELECT is(rls_matrix.dml_count($$UPDATE public.logs_auditoria SET action='hack'$$), 0::bigint, 'dono: UPDATE bloqueado');
SELECT is(rls_matrix.dml_count($$DELETE FROM public.logs_auditoria$$), 0::bigint, 'dono: DELETE bloqueado');
...
SELECT is(rls_matrix.dml_count($$UPDATE public.logs_auditoria SET action='hack'$$), 0::bigint, 'gerente: UPDATE bloqueado');
SELECT is(rls_matrix.dml_count($$DELETE FROM public.logs_auditoria$$), 0::bigint, 'gerente: DELETE bloqueado');
...
SELECT is(rls_matrix.dml_count($$UPDATE public.logs_auditoria SET action='hack'$$), 0::bigint, 'vendedor: UPDATE bloqueado');
SELECT is(rls_matrix.dml_count($$DELETE FROM public.logs_auditoria$$), 0::bigint, 'vendedor: DELETE bloqueado');
...
SELECT is(rls_matrix.dml_count($$UPDATE public.logs_auditoria SET action='x'$$), 0::bigint, 'anon: UPDATE bloqueado');
SELECT is(rls_matrix.dml_count($$DELETE FROM public.logs_auditoria$$), 0::bigint, 'anon: DELETE bloqueado');
