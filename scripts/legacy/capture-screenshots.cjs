...
const routes = [
  ...
  '/funil', '/lancamento-diario', '/historico', '/classificacao', '/relatorio-matinal', '/financeiro', '/inventory',
  ...
  '/reports/stock', '/activities', '/gamification', '/devolutivas', '/notificacoes', '/produtos',
