...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Dashboard')]").nth(0).is_visible(), "The app should show the Dashboard after successful vendedor login."
        assert not await frame.locator("xpath=//*[contains(., 'Admin')]").nth(0).is_visible(), "Manager or admin controls should not be visible to a vendedor user after login."
