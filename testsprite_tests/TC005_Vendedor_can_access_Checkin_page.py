...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field (element 6) with vendedor@mxperformance.test.
        ...
        # -> Navigate to http://localhost:5173/checkin and verify the page contains 'Checkin', 'Check-in', or 'Check in'.
