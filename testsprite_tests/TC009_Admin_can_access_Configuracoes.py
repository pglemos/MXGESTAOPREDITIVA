...
async def run_test():
    ...
    try:
        ...
        # -> Open the profile menu (top-right) and click the 'Configurações' entry to navigate to /configuracoes, then verify the page loads.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/header/div[2]/button').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Navigate to /configuracoes and verify the Configurações page loads successfully.
