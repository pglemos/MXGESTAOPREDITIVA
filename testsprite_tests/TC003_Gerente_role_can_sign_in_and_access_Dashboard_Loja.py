...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with gerente@mxperformance.test, fill the password field with TESTSPRITE_PASSWORD_REQUIRED, then submit the form by clicking the Entrar button (index 10).
