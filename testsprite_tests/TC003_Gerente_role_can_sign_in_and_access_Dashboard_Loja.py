...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with gerente@mxperformance.com.br, fill the password field with Mx#2026!, then submit the form by clicking the Entrar button (index 10).
