...
export default function BaseEstatistica({ filtro, usou90, confianca, periodoCalculo }) {
  ...
  return (
    <div className="rounded-xl border border-slate-100 bg-slate-50 p-4">
      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-3">Base estatística</p>
      <div className="flex flex-wrap gap-x-8 gap-y-2 text-[12px]">
        ...
        <div className="flex items-center gap-2">
          <span className="text-slate-400">Confiança da projeção:</span>
