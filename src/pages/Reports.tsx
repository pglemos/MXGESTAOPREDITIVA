        ...
        <main className="w-full h-full flex flex-col gap-mx-lg p-4 md:p-mx-lg overflow-y-auto no-scrollbar bg-surface-alt">
            ...
            <header className="flex flex-col lg:flex-row lg:items-center justify-between gap-mx-lg border-b border-border-default pb-10 shrink-0">
                ...
                <div className="flex flex-wrap items-center gap-mx-sm shrink-0">
                    ...
                    <Button onClick={() => toast.success('Compilando Snapshot...')} className="h-mx-xl px-8 rounded-mx-full shadow-mx-lg bg-brand-secondary uppercase font-black tracking-widest text-xs">
                            ...
                            <div className="flex items-center gap-mx-md relative z-10">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <Badge variant={stat.tone as any} className="text-tiny px-2 h-mx-5 font-black uppercase shadow-sm border-none">{stat.trend}</Badge>
                                    </div>
                                </div>
                            </div>
                        </Card>
                        ...
                        <CardContent className="p-4 md:p-mx-lg flex-1 flex flex-col items-center">
                            ...
                            <div className="w-full space-y-mx-xs">
                                {stockAgingData.map((item, i) => (
                                    <div key={i} className="flex items-center justify-between p-mx-sm rounded-mx-xl bg-surface-alt border border-border-default hover:bg-white hover:shadow-mx-md transition-all group/legend">
                                        <div className="flex items-center gap-mx-xs">
                                            <div className="w-2.5 h-2.5 rounded-mx-full shadow-mx-sm" style={{ backgroundColor: item.color }} />
            ...
            <Card className="mb-20 border-none shadow-mx-xl bg-white overflow-hidden">
                <CardHeader className="bg-surface-alt/30 border-b border-border-default p-mx-10 flex flex-col md:flex-row md:items-center justify-between gap-mx-lg">
                    <div className="flex items-center gap-mx-md">
                        <div className="w-mx-14 h-mx-14 rounded-mx-xl bg-brand-secondary text-white flex items-center justify-center shadow-mx-lg transform -rotate-3"><RefreshCw size={28} /></div>
                        <div>
                    ...
                    <table className="w-full text-left">
                        ...
                        <tbody className="divide-y divide-border-default bg-white">
                            {processedDescontos.map((d, i) => (
                                <tr key={d.seller} className={cn("hover:bg-surface-alt/30 transition-colors h-mx-3xl group")}>
                                    <td className="pl-10 py-4">
                                        <div className="flex items-center gap-mx-sm">
                                            <div className="w-mx-xl h-mx-xl rounded-mx-lg bg-surface-alt border border-border-default flex items-center justify-center font-black text-xs text-text-tertiary group-hover:bg-brand-primary group-hover:text-white transition-all shadow-mx-inner uppercase">{d.seller.substring(0, 2)}</div>
                                    ...
                                    <td className="pr-10 py-4 text-right">
                                        <Badge variant={i < 2 ? 'success' : 'warning'} className="px-6 py-2 rounded-mx-full font-black text-tiny tracking-widest shadow-sm border-none uppercase">
