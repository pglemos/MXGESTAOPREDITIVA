        ...
        <main className="w-full h-full flex flex-col gap-mx-lg p-mx-lg overflow-y-auto no-scrollbar bg-surface-alt" id="main-content">
            ...
            <PageHeading
                ...
                actions={
                    <div className="flex items-center gap-mx-sm shrink-0">
                        <Button variant="outline" size="icon" onClick={fetchSettings} disabled={isRefetching} className="w-mx-xl h-mx-xl rounded-mx-lg shadow-mx-sm bg-white border border-border-subtle hover:bg-surface-alt text-text-secondary" aria-label="Recarregar configurações">
                            <RefreshCw size={20} className={cn(isRefetching && "animate-spin")} aria-hidden="true" />
                        </Button>
                        <Button onClick={handleSave} disabled={saving || !selectedStoreId} className="h-mx-xl px-10 rounded-mx-lg shadow-mx-lg bg-brand-primary hover:bg-brand-primary-hover text-white font-black uppercase text-xs tracking-widest">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-mx-lg pb-32">
                <aside className="lg:col-span-4 flex flex-col gap-mx-lg">
                    <Card className="rounded-mx-lg border border-border-subtle p-mx-md space-y-mx-md bg-white shadow-mx-sm">
                        <header className="flex items-center gap-mx-sm border-b border-border-subtle pb-4">
                            <div className="w-mx-14 h-mx-14 rounded-mx-lg bg-surface-alt border border-border-subtle flex items-center justify-center text-brand-primary shadow-inner" aria-hidden="true"><Settings2 size={28} /></div>
                        ...
                        <div className="space-y-mx-sm">
                            ...
                            <div className="relative group">
                                <select
                                    ...
                                    className="w-full h-mx-14 px-6 bg-surface-alt border border-border-subtle rounded-mx-lg text-sm font-bold text-text-primary outline-none focus:border-brand-primary focus:ring-4 focus:ring-brand-primary/5 transition-all appearance-none cursor-pointer shadow-inner uppercase"
                                >
                        ...
                        {selectedStoreId && (
                            <div className="p-mx-md bg-mx-indigo-50 border border-mx-indigo-100 shadow-inner flex items-center gap-mx-sm rounded-mx-lg" role="status">
                ...
                <section className="lg:col-span-8">
                    <Card className="rounded-mx-lg border border-border-subtle p-mx-md bg-white space-y-mx-md shadow-mx-sm">
                        <header className="border-b border-border-subtle pb-4 flex items-center justify-between gap-mx-sm">
                            <div>
                        ...
                        <div className="space-y-mx-10" role="group" aria-label="Lista de políticas operacionais">
                            {[
                                ...
                                <div key={s.field} className="flex items-center justify-between group p-mx-md rounded-mx-lg hover:bg-surface-alt transition-all">
                                    ...
                                    <Button
                                        ...
                                        disabled
                                        className="w-mx-3xl h-mx-xl rounded-mx-lg font-black text-mx-tiny shadow-sm bg-white border border-border-subtle"
                                ...
                                <div className="flex items-center justify-between group p-mx-md rounded-mx-lg hover:bg-surface-alt transition-all">
                                    <div className="space-y-mx-tiny">
                                    ...
                                    <div className="flex p-mx-tiny bg-white border border-border-subtle rounded-mx-lg shadow-mx-sm" role="radiogroup">
                                        <Button 
                                            variant={metaRules?.projection_mode === 'calendar' ? 'brand' : 'ghost'} size="sm"
                                            onClick={() => updateMetaRules({ projection_mode: 'calendar' })}
                                            className="h-mx-9 px-6 rounded-mx-lg text-mx-tiny uppercase font-black"
                                        >
                                            CALENDÁRIO
                                        </Button>
                                        <Button 
                                ...
                                <div className="relative">
                                    ...
                                    <input aria-label="Escolher horário limite"
                                        ...
                                        disabled
                                        className="h-mx-xl pl-10 pr-6 bg-white border border-border-subtle rounded-mx-lg font-mono-numbers font-black text-sm text-text-primary focus:border-brand-primary outline-none shadow-mx-inner transition-all disabled:opacity-50"
                                    />
                                </div>
                            </div>
                        </div>

                        <footer className="pt-12 border-t border-border-subtle flex items-start gap-mx-sm">
                    ...
                    {selectedStoreId && (
                        <Card className="mt-mx-lg p-mx-md border border-border-subtle shadow-mx-sm bg-white space-y-mx-md rounded-mx-lg">
                                ...
                                {[
                                    ...
                                    <div key={list.key} className="space-y-mx-sm">
                                        <div className="flex items-center justify-between px-2">
                                            ...
                                            <Badge variant="outline" className="text-mx-micro font-black border-border-subtle uppercase">{emailLists[list.key as keyof typeof emailLists].split(',').filter(Boolean).length} E-mails</Badge>
                                        </div>
                                        ...
                                        <textarea 
                                            ...
                                            className="w-full h-mx-3xl p-mx-md bg-surface-alt border border-border-subtle rounded-mx-lg text-xs font-bold focus:border-brand-primary focus:ring-4 focus:ring-brand-primary/5 transition-all outline-none resize-none shadow-mx-inner"
                                        />
                                    </div>
                                ))}
                            </div>

                            <div className="bg-mx-indigo-50 p-mx-md rounded-mx-lg border border-border-subtle flex items-center gap-mx-sm">
