        ...
        <main className="w-full h-full flex flex-col gap-mx-lg p-mx-lg overflow-y-auto no-scrollbar bg-surface-alt">
            ...
            <header className="flex flex-col lg:flex-row lg:items-center justify-between gap-mx-lg border-b border-border-default pb-10 shrink-0">
                <div className="flex flex-col gap-1">
                    ...
                    <Typography variant="caption" className="pl-mx-md uppercase tracking-widest">PERFIL & EXPERIÊNCIA DO ESPECIALISTA</Typography>
                </div>

                <div className="flex items-center gap-mx-sm">
                    <Button variant="outline" onClick={() => signOut()} className="h-12 px-6 text-status-error border-status-error/20 hover:bg-status-error-surface rounded-xl">
                        <LogOut size={18} className="mr-2" /> Encerrar Sessão
                    </Button>
                    <Button onClick={handleSave} disabled={saving} className="h-14 px-10 rounded-full shadow-mx-xl">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-mx-lg pb-32">
                <section className="xl:col-span-8 flex flex-col gap-mx-lg">
                    ...
                    <Card className="p-10 md:p-14 border-none shadow-mx-lg bg-white">
                        <div className="flex items-center gap-8 mb-14 border-b border-border-default pb-10">
                            <div className="relative group">
                                <div className="w-28 h-24 rounded-mx-3xl bg-surface-alt border border-border-default flex items-center justify-center shadow-inner overflow-hidden">
                                    <img 
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-4">
                                    <Badge variant="brand" className="px-4 py-1 uppercase font-black">{role}</Badge>
                                    <div className="flex items-center gap-2">
                                        <div className="w-1.5 h-1.5 rounded-full bg-status-success shadow-mx-sm" />
                                        <Typography variant="caption" tone="muted" className="tracking-widest">MEMBRO ATIVO MX</Typography>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSave} className="grid md:grid-cols-2 gap-mx-lg">
                            ...
                            <div className="md:col-span-2 pt-8 border-t border-border-default flex items-start gap-4">
                                <Info size={18} className="text-brand-primary shrink-0 mt-0.5" />
                                <Typography variant="p" tone="muted" className="text-xs uppercase leading-relaxed opacity-60">Os dados de e-mail e hierarquia são gerenciados exclusivamente pela administração da rede.</Typography>
                            </div>
                        </form>
                    </Card>
                    ...
                    <Card className="p-10 md:p-14 border-none shadow-mx-lg bg-white">
                        <header className="flex items-center gap-4 mb-12 border-b border-border-default pb-8">
                            ...
                            <div>
                                <Typography variant="h3">Canais de Alerta</Typography>
                                <Typography variant="caption" tone="muted" className="uppercase tracking-widest mt-1">GERENCIAMENTO DE NOTIFICAÇÕES</Typography>
                            </div>
                        </header>
                        
                        <div className="space-y-6">
                            <Card className="flex items-center justify-between p-8 bg-surface-alt border-none shadow-inner group hover:bg-white hover:shadow-mx-sm transition-all">
                                <div className="space-y-1">
                                    <Typography variant="h3" className="text-base uppercase tracking-tight">Notificações Push</Typography>
                                    <Typography variant="p" tone="muted" className="text-xs lowercase tracking-normal">Alertas de gaps, rituais pendentes e novos feedbacks</Typography>
                                </div>
                                <Button 
                ...
                <aside className="xl:col-span-4 flex flex-col gap-mx-lg">
                    ...
                    <Card className="p-10 bg-pure-black text-white border-none shadow-mx-xl relative overflow-hidden group">
                        ...
                        <div className="absolute top-0 right-0 w-48 h-48 bg-brand-primary/10 rounded-full blur-3xl -mr-24 -mt-24" aria-hidden="true" />
                        
                        <header className="flex items-center gap-4 mb-12 relative z-10">
                            <div className="w-14 h-14 rounded-mx-xl bg-white/10 flex items-center justify-center border border-white/10 shadow-inner"><Palette size={28} className="text-indigo-400" /></div>
                            <div>
                                <Typography variant="h3" tone="white">Estética MX</Typography>
                                <Typography variant="caption" tone="white" className="opacity-40 uppercase tracking-widest mt-1">PERSONALIZAÇÃO</Typography>
                            </div>
                        </header>
                        ...
                        <div className="space-y-8 relative z-10">
                            <div className="flex items-center justify-between group/item">
                                ...
                                <Button 
                                    ...
                                    className="bg-white/5 border-white/10 text-white hover:bg-white/10 rounded-lg px-6"
                            ...
                            <div className="pt-8 border-t border-white/10">
                                <Typography variant="caption" tone="white" className="opacity-20 uppercase tracking-[0.3em] font-black text-[8px] text-center block">VERSÃO DO TERMINAL: 4.0.2-STABLE</Typography>
                            </div>
                        </div>
                    </Card>
                    ...
                    <Card className="p-10 md:p-12 border-none shadow-mx-lg bg-white space-y-10">
                        <header className="flex items-center gap-4 border-b border-border-default pb-8">
                            <div className="w-14 h-14 rounded-mx-xl bg-surface-alt flex items-center justify-center text-text-tertiary shadow-inner border border-border-default"><ShieldCheck size={28} /></div>
                            <Typography variant="h3">Segurança</Typography>
                        </header>
                        
                        <div className="space-y-6">
                            <Button variant="outline" className="w-full h-16 rounded-mx-2xl justify-between px-8 border-border-strong group hover:border-brand-primary transition-all shadow-sm font-black text-[10px] uppercase tracking-widest">
                            ...
                            <Card className="p-6 bg-status-info-surface border border-mx-blue-100 shadow-inner">
                                <Typography variant="caption" tone="info" className="text-[8px] text-center block font-black uppercase tracking-widest">Sua sessão expira em 24h por protocolo SSL</Typography>
                            </Card>
                        </div>
                    </Card>
                </aside>
