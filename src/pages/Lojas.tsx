                        ...
                        <form onSubmit={handleCreate} className="inner-card p-10 md:p-14 space-y-10 relative overflow-hidden bg-white border-none">
                            ...
                            <div className="pt-8 relative z-10 flex flex-col-reverse sm:flex-row justify-end gap-4 border-t border-gray-50">
                                ...
                                <button
                                    ...
                                    className="px-12 py-5 rounded-[2.5rem] bg-indigo-600 text-white font-black flex items-center justify-center gap-3 hover:bg-indigo-700 hover:shadow-[0_20px_40px_-10px_rgba(79,70,229,0.5)] transition-all disabled:opacity-50 active:scale-95 text-[10px] uppercase tracking-[0.3em] group/btn"
                                >
