    ...
    <main className="w-full h-full flex flex-col gap-mx-lg p-4 md:p-mx-lg overflow-y-auto no-scrollbar bg-surface-alt">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-mx-lg flex-1 min-h-0 pb-32">
        ...
        <section className="lg:col-span-4 space-y-mx-lg h-full overflow-y-auto no-scrollbar pr-2">
          ...
          {/* Season Pass Concept */}
          <Card className="p-mx-10 border-none bg-pure-black text-white shadow-mx-2xl relative overflow-hidden group mt-10">
            <div className="absolute top-mx-0 right-mx-0 w-mx-sidebar-expanded h-mx-64 bg-brand-primary/20 rounded-mx-full blur-mx-xl -mr-32 -mt-32 animate-pulse" />
            <div className="relative z-10">
                ...
                <Button className="w-full bg-brand-primary hover:bg-brand-secondary text-white border-none h-mx-14 rounded-mx-xl font-black uppercase tracking-widest shadow-mx-lg transition-all active:scale-95">
                    Ver Recompensas
                </Button>
            </div>
          </Card>
