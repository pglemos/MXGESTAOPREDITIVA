      ...
      <div className="flex flex-col lg:flex-row gap-mx-lg flex-1 min-h-0 pb-mx-3xl">
        <div className="lg:col-span-8 flex flex-col gap-mx-lg h-full">
          <div className="bg-white border border-gray-100 rounded-[2.5rem] h-full flex flex-col overflow-hidden shadow-sm group">
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar p-mx-lg space-y-4">
                ...
                {filtered.map((n, i) => (
                  ...
                  >
                    <div className={cn(
                      ...
                      n.read ? "bg-gray-50" : "bg-white border border-gray-50"
                    )}>
                      {getTypeIcon(n.type)}
                    </div>
        ...
        <div className="lg:col-span-4 flex flex-col gap-mx-lg">
          <div className="bg-white border border-gray-100 rounded-[2.5rem] p-8 space-y-mx-lg h-full flex flex-col shadow-sm">
            ...
            <div className="space-y-3 flex-1 mt-6">
              {[
                ...
                <button key={f.label} className="w-full p-5 rounded-2xl border border-gray-100 bg-gray-50/50 hover:bg-white hover:border-indigo-200 hover:shadow-lg transition-all text-left flex items-center justify-between group/f">
                  <span className="text-[9px] font-black text-slate-900 uppercase tracking-widest">{f.label}</span>
                  <ChevronRight size={14} className="text-gray-300 group-hover/f:text-indigo-600 transition-all" />
                </button>
              ))}
            </div>
            <div className="pt-8 border-t border-gray-100"><button className="w-full h-14 rounded-full bg-gray-50 text-[10px] font-black uppercase tracking-[0.3em] text-gray-400 hover:bg-slate-950 hover:text-white transition-all shadow-inner">Ajustes de Alerta</button></div>
          </div>
        </div>
      </div>
    </div>
