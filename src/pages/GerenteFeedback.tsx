    ...
    return (
        <main className="w-full h-full flex flex-col gap-10 overflow-y-auto no-scrollbar relative text-pure-black p-4 sm:p-6 md:p-10">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 relative z-10 w-full shrink-0 border-b border-gray-100 pb-10">
                <div className="flex flex-col gap-1">
                    ...
                    <div className="flex items-center gap-3 pl-6 mt-2">
                        ...
                        <p className="text-gray-500 text-xs font-black uppercase tracking-[0.4em] italic">Rotina Semanal Mandatória • Critério 20/60/33</p>
                    </div>
                </div>

                <div className="flex flex-col sm:flex-row items-center gap-4 shrink-0">
                    {/* Tab Switcher */}
                    <div className="flex p-1 bg-gray-100 border border-gray-200 rounded-2xl" role="tablist" aria-label="Abas de Feedback">
                        <button
                            role="tab"
                            aria-selected={activeTab === 'individual'}
                            onClick={() => setActiveTab('individual')}
                            className={cn(
                                "flex items-center gap-2 px-6 py-3 rounded-xl text-xs font-black uppercase tracking-widest transition-all outline-none focus-visible:ring-2 focus-visible:ring-slate-500",
                    ...
                    <div className="relative group w-full sm:w-64">
                        ...
                        <label htmlFor="feedback-search" className="sr-only">Buscar vendedor ou conteúdo</label>
                        <input 
                            id="feedback-search"
                            type="text"
                            placeholder="Buscar..."
                            ...
                            className="mx-input !py-3 focus:ring-4 focus:ring-indigo-500/5 outline-none"
                        />
                    </div>
                    <button 
                        onClick={handleRefresh}
                        aria-label="Atualizar lista"
                        className="w-12 h-12 rounded-2xl bg-white border border-gray-100 shadow-sm flex items-center justify-center text-gray-400 hover:text-pure-black transition-all active:scale-90 focus-visible:ring-4 focus-visible:ring-indigo-500/10 outline-none"
                    >
                    ...
                    {activeTab === 'individual' && canCreateFeedback && (
                        <button
                            ...
                            className="mx-button-primary !px-8 !py-4 hover:bg-brand-secondary-hover shadow-3xl group relative overflow-hidden focus-visible:ring-4 focus-visible:ring-indigo-500/20 outline-none"
                        >
                    ...
                    {activeTab === 'individual' && isExecutiveView && (
                        <div className="flex items-center gap-2 px-6 py-3 rounded-xl bg-gray-50 border border-gray-100 text-[10px] font-black text-gray-500 uppercase tracking-widest shadow-inner">
                            <LayoutDashboard size={14} aria-hidden="true" /> Visão Executiva
                        </div>
                    )}
                </div>
            </div>
            ...
            <AnimatePresence mode="wait">
                {activeTab === 'individual' ? (
                    <motion.section key="individual" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} className="space-y-10 pb-32" aria-live="polite">
                        <AnimatePresence>
                                    ...
                                    <form onSubmit={handleSubmit} className="mx-card !border-none p-10 md:p-14 space-y-10 relative overflow-hidden bg-white" aria-labelledby="feedback-form-title">
                                        ...
                                        <div className="flex items-center justify-between relative z-10 border-b border-gray-100 pb-8">
                                            <div className="flex items-center gap-6">
                                                ...
                                                <div>
                                                    <h2 id="feedback-form-title" className="text-2xl font-black text-pure-black tracking-tighter leading-none mb-2 uppercase">Auditoria de Performance MX</h2>
                                                    <p className="text-gray-500 text-xs font-black uppercase tracking-[0.3em]">Feedback Estruturado • Ciclo Semanal</p>
                                                </div>
                                            </div>
                                            <button type="button" onClick={() => setShowForm(false)} aria-label="Fechar formulário" className="w-12 h-12 rounded-xl bg-gray-50 border border-gray-100 flex items-center justify-center text-gray-400 hover:bg-red-50 hover:text-red-500 hover:rotate-90 transition-all outline-none focus-visible:ring-4 focus-visible:ring-red-500/10">
                                        ...
                                        <div className="grid lg:grid-cols-2 gap-12 relative z-10">
                                            <div className="space-y-8">
                                                <fieldset className="space-y-8">
                                                    <legend className="sr-only">Dados do Vendedor e Performance</legend>
                                                    <div className="space-y-4">
                                                        <label htmlFor="seller-select" className="text-xs font-black text-gray-500 uppercase tracking-widest ml-2 leading-none">Vendedor Analisado</label>
                                                        <select
                                                            id="seller-select"
                                                            ...
                                                            <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} className="p-8 bg-slate-950 rounded-[2.5rem] text-white space-y-8 shadow-2xl relative overflow-hidden group">
                                                                ...
                                                                <div className="flex items-center justify-between relative z-10">
                                                                    <div className="flex items-center gap-2">
                                                                        ...
                                                                        <span className="text-xs font-black text-indigo-300 uppercase tracking-[0.3em]">Auditoria Técnica (Semana)</span>
                                                                    </div>
                                                                            ...
                                                                            <div key={metric.label} className="space-y-3">
                                                                                <div className="flex justify-between items-end">
                                                                                    ...
                                                                                    <div className="flex flex-col items-end gap-1">
                                                                                        ...
                                                                                        <span className="text-[10px] font-black text-white/30 uppercase tracking-widest">Ideal: {metric.bench}%</span>
                                                                                    </div>
                                                                                </div>
                                                            ...
                                                            {/* Evolução Histórica */}
                                                             ...
                                                             >
                                                                 <div className="flex items-center justify-between mb-8">
                                                                     <div className="flex flex-col gap-1">
                                                                         <h4 className="text-xs font-black text-indigo-400 uppercase tracking-[0.2em]">Tendência de Entrega</h4>
                                                                         <p className="text-[10px] font-black text-white/40 uppercase tracking-widest">Vendas Totais / Últimas 6 Semanas</p>
                                                                     </div>
                                                ...
                                                <fieldset className="space-y-8">
                                                    <legend className="sr-only">Conteúdo do Feedback</legend>
                                                    <div className="space-y-4">
                                                        <label htmlFor="meta-compromisso" className="flex items-center gap-2 text-xs font-black text-amber-700 uppercase tracking-widest ml-2 leading-none">
                                                            <Target size={14} aria-hidden="true" /> Meta Compromisso (Próxima Semana)
                                                        </label>
                                                        <input
                                                            id="meta-compromisso"
                                                            type="number"
                                                            ...
                                                            className="mx-input outline-none focus:ring-4 focus:ring-amber-500/5"
                                                        />
                                                        <p className="text-[10px] font-bold text-gray-500 uppercase tracking-normal ml-2 leading-tight">
                                                            Sugerido pela média recente: <span className="text-amber-700 font-black">{commitmentSuggested} venda(s)</span>.
                                                        </p>
                                                    </div>

                                                    <div className="space-y-4">
                                                        <label htmlFor="positives" className="flex items-center gap-2 text-xs font-black text-emerald-700 uppercase tracking-widest ml-2 leading-none">
                                                            <Award size={14} aria-hidden="true" /> Pontos Positivos
                                                        </label>
                                                        <textarea
                                                            id="positives"
                                                            ...
                                                            className="mx-input !rounded-[2rem] h-32 resize-none py-6 outline-none focus:ring-4 focus:ring-emerald-500/5"
                                                        />
                                                    </div>

                                                    <div className="space-y-4">
                                                        <label htmlFor="attention-points" className="flex items-center gap-2 text-xs font-black text-rose-700 uppercase tracking-widest ml-2 leading-none">
                                                            <AlertCircle size={14} aria-hidden="true" /> Gargalo Identificado (Atenção)
                                                        </label>
                                                        <textarea
                                                            id="attention-points"
                                                            ...
                                                            className="mx-input !rounded-[2rem] h-32 resize-none py-6 outline-none focus:ring-4 focus:ring-rose-500/5"
                                                        />
                                                    </div>

                                                    <div className="space-y-4">
                                                        <label htmlFor="action-plan" className="flex items-center gap-2 text-xs font-black text-indigo-700 uppercase tracking-widest ml-2 leading-none">
                                                            <Zap size={14} aria-hidden="true" /> Missão & Plano de Ação
                                                        </label>
                                                        <textarea
                                                            id="action-plan"
                                                            value={form.action}
                                                            ...
                                                            className="mx-input !rounded-[2rem] h-32 resize-none py-6 outline-none focus:ring-4 focus:ring-indigo-500/5"
                                                        />
                                                    </div>
                                                </fieldset>
                                            </div>
                                        ...
                                        <div className="pt-8 border-t border-gray-100 flex justify-end">
                                            <button
                                                ...
                                                className="mx-button-primary hover:bg-brand-secondary-hover disabled:opacity-50 group/btn focus-visible:ring-4 focus-visible:ring-indigo-500/20 outline-none"
                                            >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                    ...
                                    >
                                        ...
                                        <div className="flex items-start justify-between mb-10 relative z-10 border-b border-gray-100 pb-6">
                                            <div className="flex items-center gap-4 min-w-0">
                                                ...
                                                <div className="min-w-0">
                                                    <h3 className="text-base font-black text-slate-950 truncate uppercase tracking-tight group-hover:text-indigo-600 transition-colors">{(f as any).seller_name}</h3>
                                                    <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest">
                                                        <time dateTime={f.created_at}>{format(parseISO(f.created_at), 'dd/MM/yyyy')}</time>
                                                    </p>
                                                </div>
                                            </div>
                                            <div className={cn("px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest border shadow-sm shrink-0", 
                                        ...
                                        <div className="space-y-6 flex-1 relative z-10">
                                            <div className="space-y-3">
                                                <div className="flex items-center gap-2 text-xs font-black text-emerald-700 uppercase tracking-widest leading-none">
                                                    <Award size={14} aria-hidden="true" /> Pontos Positivos
                                                </div>
                                                <p className="text-sm font-bold text-gray-600 line-clamp-2 leading-relaxed italic">"{f.positives}"</p>
                                            </div>
                                            <div className="space-y-3">
                                                <div className="flex items-center gap-2 text-xs font-black text-rose-700 uppercase tracking-widest leading-none">
                                                    <AlertCircle size={14} aria-hidden="true" /> Atenção
                                                </div>
                                                <p className="text-sm font-bold text-gray-600 line-clamp-2 leading-relaxed italic">"{f.attention_points}"</p>
                                            </div>
                                            <div className="pt-6 border-t border-gray-100">
                                                <div className="flex items-center justify-between mb-3">
                                                    <div className="flex items-center gap-2 text-xs font-black text-indigo-700 uppercase tracking-widest leading-none">
                                                        <Target size={16} strokeWidth={2.5} aria-hidden="true" /> Missão Definida
                                                    </div>
                                                    <div className="text-[10px] font-black text-amber-700 uppercase tracking-widest bg-amber-50 px-2 py-1 rounded-md border border-amber-100">
                                                        Meta: {(f as any).meta_compromisso || 0}
                                                    </div>
                                                </div>
                                                <p className="text-base font-black text-slate-950 leading-tight uppercase tracking-tight">{f.action}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-8 pt-6 border-t border-gray-100 flex items-center justify-between opacity-0 group-hover:opacity-100 transition-opacity">
                                            <div className="flex items-center gap-2">
                                                <button 
                                                    ...
                                                    className="w-10 h-10 rounded-xl bg-emerald-50 text-emerald-600 flex items-center justify-center hover:bg-emerald-600 hover:text-white transition-all shadow-sm focus-visible:ring-4 focus-visible:ring-emerald-500/20 outline-none"
                                                ...
                                                <button 
                                                    ...
                                                    className="w-10 h-10 rounded-xl bg-indigo-50 text-indigo-600 flex items-center justify-center hover:bg-indigo-600 hover:text-white transition-all shadow-sm disabled:opacity-50 focus-visible:ring-4 focus-visible:ring-indigo-500/20 outline-none"
                                                    aria-label="Enviar p/ E-mail"
                                                >
                                                    {sendingEmail === f.id ? <RefreshCw size={16} className="animate-spin" aria-hidden="true" /> : <Send size={16} aria-hidden="true" />}
                                                </button>
                                            </div>
                                            <button 
                                                onClick={() => handlePrint(f)}
                                                className="flex items-center gap-2 px-4 py-2 rounded-xl bg-gray-50 text-gray-500 hover:text-slate-900 hover:bg-white border border-transparent hover:border-gray-200 transition-all text-[10px] font-black uppercase tracking-widest shadow-sm outline-none focus-visible:ring-4 focus-visible:ring-indigo-500/10"
                                            >
                                                <FileText size={14} aria-hidden="true" /> Design Legado (PDF)
                                            </button>
                                        </div>
                                    </article>
                                ))}
                            ...
                            {filteredFeedbacks.length === 0 && (
                                <div className="col-span-full py-40 rounded-[4rem] text-center border-dashed border-2 border-gray-200 bg-gray-50/30 flex flex-col items-center justify-center relative overflow-hidden group">
                                    ...
                                    <h2 className="text-3xl font-black text-slate-950 mb-4 tracking-tighter uppercase">Sem Feedbacks Registrados</h2>
                                    ...
                                    {canCreateFeedback && (
                                        <button type="button" onClick={() => {setSearchTerm(''); setShowForm(true)}} className="mx-button-primary hover:bg-brand-secondary-hover px-10 py-4 shadow-3xl focus-visible:ring-4 focus-visible:ring-indigo-500/20 outline-none">
                    ...
                    <motion.section key="weekly" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8 pb-32" aria-live="polite">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {reports.map((report, i) => (
                                <article
                                    key={report.id}
                                    className="mx-card p-8 hover:shadow-elevation transition-all group relative overflow-hidden bg-white"
                                >
                                    ...
                                    <div className="flex items-center justify-between mb-8 relative z-10">
                                        <div className="flex items-center gap-3">
                                            <div className="w-12 h-12 rounded-2xl bg-slate-950 text-white flex items-center justify-center shadow-lg" aria-hidden="true">
                                                <Calendar size={20} />
                                            </div>
                                            <div>
                                                <h3 className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Período</h3>
                                        ...
                                        <Badge className={cn(
                                            "text-[10px] font-black tracking-widest border-none px-2 py-1",
                                            report.email_status === 'sent' ? "bg-emerald-500/30 text-emerald-700" : "bg-rose-500/30 text-rose-700"
                                        )}>
                                    ...
                                    <div className="grid grid-cols-2 gap-4 mb-8 relative z-10">
                                        <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100">
                                            <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-1">Meta Semanal</p>
                                            <p className="text-xl font-black text-slate-950">{report.weekly_goal}v</p>
                                        </div>
                                        <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100">
                                            <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-1">Média Team</p>
                                            <p className="text-xl font-black text-slate-950">{(report.team_avg_json as any).vnd || 0}v</p>
                                        </div>
                                    </div>

                                    <div className="space-y-2 mb-8 relative z-10">
                                        <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Diagnóstico da Rede</p>
                                        <div className="flex items-center gap-2">
                                            <div className="w-2 h-2 rounded-full bg-indigo-500" aria-hidden="true" />
                                            <p className="text-xs font-bold text-gray-700 uppercase leading-tight line-clamp-2 italic">
                                    ...
                                    <div className="pt-6 border-t border-gray-100 flex items-center justify-between mt-auto relative z-10">
                                        <div className="flex -space-x-2" aria-label="Principais destaques">
                                            {(report.ranking_json as any[]).slice(0, 3).map((s, idx) => (
                                                <div key={idx} className="w-8 h-8 rounded-full bg-white border-2 border-gray-100 flex items-center justify-center text-[10px] font-black text-indigo-700 shadow-sm" title={s.name}>
                                                    {s.name.charAt(0)}
                                                </div>
                                            ))}
                                            {(report.ranking_json as any[]).length > 3 && (
                                                <div className="w-8 h-8 rounded-full bg-gray-100 border-2 border-gray-100 flex items-center justify-center text-[8px] font-black text-gray-500">
                                                    +{(report.ranking_json as any[]).length - 3}
                                                </div>
                                            )}
                                        </div>
                                        ...
                                        <div className="flex items-center gap-3">
                                            <a
                                                ...
                                                className="flex items-center gap-2 text-[10px] font-black text-indigo-700 uppercase tracking-widest hover:text-indigo-900 transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 outline-none rounded p-1"
                                            >
                                                CSV <ExternalLink size={12} aria-hidden="true" />
                                            </a>
                                            <button 
                                                onClick={() => handlePrintWeekly(report)}
                                                className="flex items-center gap-2 text-[10px] font-black text-gray-500 hover:text-slate-900 uppercase tracking-widest transition-colors focus-visible:ring-2 focus-visible:ring-slate-500 outline-none rounded p-1"
                                            >
                            ...
                            {reports.length === 0 && (
                                <div className="col-span-full py-40 rounded-[4rem] text-center border-dashed border-2 border-gray-200 bg-gray-50/30 flex flex-col items-center justify-center relative overflow-hidden group">
                                    ...
                                    <h2 className="text-3xl font-black text-slate-950 mb-4 tracking-tighter uppercase">Histórico em Branco</h2>
                                    <p className="text-gray-500 text-sm font-bold max-w-sm mx-auto mb-8">
