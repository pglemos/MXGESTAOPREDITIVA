...
export function CentralTabs({ value, onChange }: {
  ...
  return (
    <div className="sticky top-16 z-20 border-b border-[#E5E7EB] bg-white px-5 sm:px-6">
      <div className="flex" role="tablist" aria-label="Central de Execução">
        {TABS.map(tab => (
          <button
            ...
            className={cn(
              'border-b-2 px-5 py-3.5 text-[13px] font-bold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#005BFF]/30',
              value === tab.id
