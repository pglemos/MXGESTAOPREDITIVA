...
function emptyDraft(initialDate: string, sellerId = ''): ManagerFeedbackDraft {
  return { sellerId, date: initialDate, type: '', competency: '', origin: ORIGINS[0], situation: '', impact: '', orientation: '', commitment: '', deadline: '', nextConversation: '', useAsPdiEvidence: false }
}
