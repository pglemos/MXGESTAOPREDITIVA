 ...
 *
 * Quando o vendedor não realizou o Fechamento Diário ainda, esse banner
 * aparece no topo da Home reforçando a regra "sem fechamento → sem leads".
      ...
      <div className="flex items-start gap-mx-sm md:items-center">
        ...
        <div className="min-w-0">
          ...
          <Typography variant="p" className="text-sm font-bold text-text-primary leading-tight mt-mx-tiny">
            Registre o Fechamento Diário referente a {referenceDateLabel} para liberar leads, Central de Execução e ranking.
          </Typography>
        </div>
      </div>
<Link
