...
export function PotentialCommissionCard({ comissaoProjetada, ganhoPotencial }: Props) {
  return (
    <div className="rounded-2xl p-6 flex flex-col justify-between" style={{ background: '#071525', border: '1px solid rgba(255,255,255,0.06)', minHeight: '180px' }}>
      <div>
        ...
        <p className="font-black mt-1 tabular-nums" style={{ fontSize: '2.25rem', color: '#39FF5A', textShadow: '0 0 20px rgba(57,255,90,0.3)' }}>
