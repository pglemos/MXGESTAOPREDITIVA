    ...
    <div className="space-y-6">
      ...
      {clienteAtual && etapa === "enviando" && (
        <div className="bg-white border border-slate-100 rounded-2xl p-5 space-y-4">
          ...
          <div className="flex gap-2">
            <Button variant="outline" onClick={pularCliente} className="rounded-xl gap-1.5 text-sm text-slate-500">
              <SkipForward className="w-4 h-4" /> Pular
            </Button>
            <Button onClick={marcarEnviado} className="flex-1 rounded-xl bg-blue-50 text-[#005BFF] hover:bg-blue-100 font-bold gap-1.5 text-sm border border-blue-100">
              Mensagem enviada →
            </Button>
          </div>
        </div>
