...
const endpoints = [
  { method: 'GET', path: '/rest/v1/stores', name: 'Stores List' },
  { method: 'GET', path: '/rest/v1/daily_checkins', name: 'Checkins List' },
  { method: 'GET', path: '/rest/v1/feedbacks', name: 'Feedbacks List' },
  { method: 'GET', path: '/rest/v1/pdis', name: 'PDIs List' },
  { method: 'GET', path: '/rest/v1/training_progress', name: 'Training Progress List' },
  { method: 'GET', path: '/rest/v1/notifications', name: 'Notifications List' },
  { method: 'GET', path: '/rest/v1/memberships', name: 'Memberships List' },
  ...
  { method: 'GET', path: '/rest/v1/store_sellers', name: 'Sellers List' },
  { method: 'GET', path: '/rest/v1/trainings', name: 'Trainings List' },
