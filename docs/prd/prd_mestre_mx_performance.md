...
| `dono` | UserRole + MembershipRole | `users` + `memberships` | `/lojas` | Suas lojas, performance, metas, funil, relatórios, feedbacks, PDIs. Visão executiva sem operar rotina diária. |
