...
**Status:** Partial MVP - contrato multi-tenant preparado  
...
- [ ] Admin/admin master MX consegue cadastrar conteudo institucional vinculado a uma loja.
- [x] Gerente/dono consegue visualizar conteudos institucionais liberados para sua loja quando a fonte estiver persistida.
- [x] Trilha de novo colaborador pode incluir conteudos institucionais da loja alem dos conteudos padrao MX no contrato de desenvolvimento.
...
- MVP pode registrar metadados e URL/anexo de conteudo; producao de video fica fora do sistema.
