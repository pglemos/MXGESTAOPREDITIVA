...
### [SEC-01] RLS Protection Hardening
...
### [PERF-01] Atomic Skeleton Implementation
**Como** Usuário Final,
...
### [ARCH-01] VendedorHome Logic Sharding
**Como** Arquiteto,
...
- [ ] RLS vulnerabilidade (SEC-01) resolvida e validada.
- [ ] Suite Playwright rodando com sucesso no CI ou local.
- [ ] Dashboards principais com 0% de layout shift visível (usando skeletons).
- [ ] Limpeza física da pasta `src/components/ui/` (Legacy) iniciada.
